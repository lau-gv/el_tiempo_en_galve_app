...
import 'package:el_tiempo_en_galve_app/features/historicalData/infraestructure/datasources/current_station_data_datasource_aws_impl%20copy.dart';
import 'package:el_tiempo_en_galve_app/features/historicalData/infraestructure/repositories/current_station_data_repository_aws_impl%20copy.dart';
...
final currentStationDataRepositoryProvider = Provider<CurrentStationDataRepository>((ref){
  ...
  return CurrentStationDataRepositoryAwsImpl(
