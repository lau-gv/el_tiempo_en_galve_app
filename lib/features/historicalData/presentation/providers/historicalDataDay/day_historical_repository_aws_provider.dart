...
import 'package:el_tiempo_en_galve_app/features/historicalData/infraestructure/repositories/day_historical_repository_aws_impl.dart';
...
final dayHistoricalRepositoryProvider = Provider<DayHistoricalRepository>((ref){
  ...
  return DayHistoricalRepositoryAwsImpl(
