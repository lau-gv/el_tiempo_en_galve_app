class HistoricalDataMonth{
  ...
  double get maxBaromrelhpa => double.parse(_maxBaromrelhpa.toStringAsExponential(2));
  double get minBaromrelhpa => double.parse(_minBaromrelhpa.toStringAsExponential(2));
  double get maxBaromabshpa => double.parse(_maxBaromabshpa.toStringAsExponential(2));
  double get minBaromabshpa => double.parse(_minBaromabshpa.toStringAsExponential(2));
  double get maxRainrateinmm => double.parse(_maxRainrateinmm.toStringAsExponential(2));
  double get minRainrateinmm => double.parse(_minRainrateinmm.toStringAsExponential(2));
  double get acumulateDailyraininmm => double.parse(_acumulateDailyraininmm.toStringAsFixed(2));
  double get maxwindspeedkmh => double.parse(_maxwindspeedkmh.toStringAsExponential(2));
  double get minwindspeedkmh => double.parse(_minwindspeedkmh.toStringAsExponential(2));
  double get maxdailygust => double.parse(_maxdailygust.toStringAsExponential(2));
  double get mindailygust => double.parse(_mindailygust.toStringAsExponential(2));
  double get maxSolarradiation => double.parse(_maxSolarradiation.toStringAsExponential(2));
  double get minSolarradiation => double.parse(_minSolarradiation.toStringAsExponential(2));
